...
export function LaunchpadHeader({
  ...
  return (
    <header
      className={`fixed max-w-[90%] sm:sticky ${isPwa ? ' top-20 ' : ' top-6 '} z-10 mb-10 flex w-full sm:max-w-5xl items-center gap-3 rounded-3xl border border-white/10 bg-white/5 px-4 py-0 sm:p-4 text-white shadow-2xl/20 backdrop-blur-sm transition-transform duration-300 hover:scale-[1.01]`}
      style={glassTint}
    >
